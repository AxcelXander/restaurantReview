package com.example.restaurantReview.tests;
...
public class restaurantReviewIT extends BaseTest {
    ...
    @Test
    public void createAndApproverestaurantReview() {
    ...
    @Test
    public void createAndRejectrestaurantReview() {
        Map<String, Object> map = new HashMap<>();
        map.put("reviewedBy", "BilboBaggins");
        map.put("restaurantId", 1);
        map.put("peanutScore", 1);
